...
class Ui_window5(object):
    def setupUi(self, window5):
        ...
        #####
        self.publishBtn = QtWidgets.QPushButton(self.centralwidget)
        self.publishBtn.setMinimumSize(QtCore.QSize(120, 35))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(11)
        ...
        window5.setTabOrder(self.backBtn, self.publishBtn)
        window5.setTabOrder(self.publishBtn, self.finishBtn)
    ...
    def retranslateUi(self, window5):
        ...
        self.publishBtn.setText(_translate("window5", "Publish"))
