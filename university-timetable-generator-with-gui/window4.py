...
class Ui_window4(object):
    def setupUi(self, window4):
        ...
        self.actionSaveAs = QtWidgets.QAction(window4)
        ...
        self.actionClear_All = QtWidgets.QAction(window4)
    ...
    def retranslateUi(self, window4):
        ...
        item.setText(_translate("window4", "8:40-9:40"))
        item = self.faculty_table.horizontalHeaderItem(1)
        item.setText(_translate("window4", "9:40-10:40"))
        item = self.faculty_table.horizontalHeaderItem(2)
        item.setText(_translate("window4", "11:00-12:00"))
        item = self.faculty_table.horizontalHeaderItem(3)
        item.setText(_translate("window4", "12:00-1:00"))
        item = self.faculty_table.horizontalHeaderItem(4)
        item.setText(_translate("window4", "1:00-1:40"))
        item = self.faculty_table.horizontalHeaderItem(5)
        item.setText(_translate("window4", "1:40-2:40"))
        item = self.faculty_table.horizontalHeaderItem(6)
        item.setText(_translate("window4", "2:40-3:40"))
        item = self.faculty_table.horizontalHeaderItem(7)
        item.setText(_translate("window4", "3:40-4:40"))
        ...
        self.actionSaveAs.setText(_translate("window4", "Save As"))
